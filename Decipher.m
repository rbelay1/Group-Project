...
Cipher1=lower(Cipher); %set Cipher word to lower case%
...
for jj=1:length(Cipher1) %create a vector jj of the length of the enciphered word%
    location2=strfind(new_alphabet,Cipher1(jj));%find the indices of each letter of the 
